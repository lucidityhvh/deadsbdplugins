    ...
    return [
      {
        title: 'fixed',
        type: 'fixed',
        items: ['Fixed force caching error']
      }
    ];
  }
  initialize() {
...
*/
    ...
    ZeresPluginLibrary.PluginUtilities.addStyle(
      ...
      `
                ...
                .${this.style.menuRoot}[style*="opacity: 0"] * {
                  pointer-events: none;
                }
  ...
  automaticallyUpdate(tryProxy) {
    const updateFail = () => XenoLib.Notifications.warn(`[${this.getName()}] Unable to check for updates!`, { timeout: 7500 });
    new Promise(resolve => {
